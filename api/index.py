...
<head>
    ...
    <style>
        ...
        body { margin: 0; font-family: 'Plus Jakarta Sans', sans-serif; background-color: var(--bg); color: var(--text-main); min-height: 100vh; display: flex; justify-content: center; align-items: center; background-image: radial-gradient(#cbd5e1 1px, transparent 1px); background-size: 32px 32px; }
        .layout-grid { display: flex; align-items: flex-start; justify-content: center; gap: 24px; width: 100%; max-width: 1400px; padding: 40px; }
        ...
        .main-card { background: var(--card-bg); backdrop-filter: blur(24px); -webkit-backdrop-filter: blur(24px); border: 1px solid #fff; border-radius: 24px; padding: 56px 48px; width: 100%; max-width: 480px; text-align: center; box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.05); }
        @media (max-width: 1150px) { body { align-items: flex-start; } .layout-grid { flex-direction: column; align-items: center; padding: 20px; } .side-ad { width: 100%; max-width: 480px; height: 250px; display: flex !important; } .side-ad.left { order: 1; margin-bottom: 24px; } .main-card { order: 2; margin-bottom: 24px; } .side-ad.right{ order: 3; } }
        h1 { font-size: 32px; font-weight: 800; margin: 0 0 12px 0; letter-spacing: -1.2px; color: #0f172a; line-height: 1.1; }
        p { color: var(--text-muted); font-size: 15px; line-height: 1.6; margin-bottom: 36px; font-weight: 500; }
        .ad-slot-inner { background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; height: 250px; margin: 24px 0; display: flex; align-items: center; justify-content: center; color: #94a3b8; font-family: 'JetBrains Mono', monospace; font-size: 10px; text-transform: uppercase; letter-spacing: 1px; }
        .btn-primary { background: #0f172a; color: white; border: none; padding: 20px; width: 100%; border-radius: 12px; font-family: 'Plus Jakarta Sans', sans-serif; font-size: 15px; font-weight: 600; cursor: pointer; transition: all 0.2s ease; box-shadow: 0 10px 15px -3px rgba(15, 23, 42, 0.2); letter-spacing: -0.3px; }
        .btn-primary:hover { transform: translateY(-2px); box-shadow: 0 20px 25px -5px rgba(15, 23, 42, 0.3); }
        .loader-container { margin-top: 32px; display: none; text-align: left; }
        .status-header { display: flex; justify-content: space-between; font-family: 'JetBrains Mono', monospace; font-size: 11px; color: var(--text-muted); margin-bottom: 12px; font-weight: 500; text-transform: uppercase; }
        ...
        .results-area { margin-top: 32px; display: none; border-top: 1px solid #f1f5f9; padding-top: 24px; }
        .download-item { display: flex; justify-content: space-between; align-items: center; padding: 16px; margin: 8px 0; background: #fff; border: 1px solid #e2e8f0; border-radius: 12px; color: var(--text-main); text-decoration: none; font-size: 14px; font-weight: 600; transition: 0.2s; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05); }
...
<body>
    <div class="layout-grid">
        ...
        <div class="main-card">
            ...
            <div class="ad-slot-inner hidden" id="ad-middle" style="margin-top: 32px;">[ Video / Media ]</div>
            <div class="results-area" id="results">
                <div style="text-align: left; margin-bottom: 16px; font-family:'JetBrains Mono'; font-size: 10px; color: #94a3b8; text-transform: uppercase; letter-spacing:1px;">Manifest Ready</div>
                ...
                <button class="btn-primary" onclick="location.reload()" style="margin-top:24px; background: white; color: #0f172a; border: 1px solid #e2e8f0; box-shadow:none;">Generate New Batch</button>
            </div>
        </div>
